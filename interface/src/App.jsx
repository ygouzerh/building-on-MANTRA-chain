...
export default function App() {
  ...
  const { fetchTodos, addTodo, updateTodo, deleteTodo, loading, setLoading } =
    useTodoContract();
  ...
  const getPriorityIcon = (priority) => {
    switch (priority.toLowerCase()) {
      ...
      case "low":
        return <WarningIcon color="green.500" />;
      default:
    ...
    updateTodo(id, description, status, todoPriority)
      .then(() => {
        setTodos((prev) =>
          prev.map((todo) =>
            todo.id === id
              ? { ...todo, description, status, priority: todoPriority }
              : todo
          )
        );
              ...
              {account && (
                <Text fontSize="sm" color={textColor}>
                  <Box border="dotted" p={1} borderRadius={5}>
                    {account.bech32Address.slice(0, 8)}...
            ...
            {isConnected ? (
              <VStack spacing={8} align="stretch">
                ...
                <Box bg={headerBgColor} p={6} borderRadius="lg" boxShadow="md">
                  ...
                  <HStack>
                    <Input
                      ...
                      onChange={(e) =>
                        setNewTodo({ ...newTodo, newTodo: e.target.value })
                      }
                ...
                <Box>
                  ...
                  {["to_do", "in_progress", "done", "cancelled"].map(
                    (statusGroup) => {
              ...
              <VStack spacing={4} align="center" justify="center" height="100%">
                ...
                <Text color={textColor}>
                  Connect your wallet to start managing your to-dos
                </Text>
                <Button size="lg" colorScheme="blue" onClick={connectWallet}>
                  Connect Wallet
                </Button>
              </VStack>
            )}
